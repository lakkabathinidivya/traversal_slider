...
import 'package:traversal_slider/src/swipe_detector.dart';
...
class CurvedCarousel extends StatefulWidget {
  ...
  /// To get initial index of curosel_slider.
  final Function(int)? getInitialIndex;
...
class _CurvedCarouselState extends State<CurvedCarousel>
  ...
  void didChangeDependencies() {
    ...
    if (widget.getInitialIndex != null) {
      widget.getInitialIndex!(_currentItemIndex);
    }
  }
